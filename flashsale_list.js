...
const listFlashsaleSlitder = document.querySelector(".flashsale__product-2")
const renderFlashsaleItemSecord = (params) => {
...
renderFlashsaleItemSecord(dataFlashsaleSlitder);
// slider 3
let dataFlashsaleSlitderThird = [
    {
        "id": "1",
        "img": "./img/flashsale/product-1.jpg",
        "price": "đ 1.890.000",
...
const listFlashsaleSlitderThird = document.querySelector(".flashsale__product-3")
const renderFlashsaleItemThird = (params) => {
...
renderFlashsaleItemThird(dataFlashsaleSlitderThird);